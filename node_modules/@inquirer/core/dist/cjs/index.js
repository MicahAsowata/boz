...
const screen_manager_mjs_1 = __importDefault(require("./lib/screen-manager.mjs"));
const options_mjs_1 = require("./lib/options.mjs");
var prefix_mjs_1 = require("./lib/prefix.mjs");
Object.defineProperty(exports, "usePrefix", { enumerable: true, get: function () { return prefix_mjs_1.usePrefix; } });
__exportStar(require("./lib/key.mjs"), exports);
__exportStar(require("./lib/Paginator.mjs"), exports);
const hooks = [];
const hooksCleanup = [];
const hooksEffect = [];
let index = 0;
